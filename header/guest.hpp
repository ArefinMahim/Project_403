...
public:
  Guest();
  Guest(int Pid, string first, string last, string ph, string mail, string addr,
        string Nid, int room, string checkin, string checkout);

  Guest(int Pid, string first, string last, string ph, string mail, string addr,
        string Nid, string username, string password);
